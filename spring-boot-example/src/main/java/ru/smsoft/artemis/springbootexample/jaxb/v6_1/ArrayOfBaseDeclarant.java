 ...
 *       &lt;sequence&gt;
 *         &lt;element name="BaseDeclarant" type="{http://asguf.mos.ru/rkis_gu/coordinate/v6_1/}BaseDeclarantType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ArrayOfBaseDeclarant {
    ...
    protected List<BaseDeclarantType> baseDeclarant;
     ...
     * {@link BaseDeclarantType }
     * 
     * 
     */
    public List<BaseDeclarantType> getBaseDeclarant() {
        if (baseDeclarant == null) {
            baseDeclarant = new ArrayList<BaseDeclarantType>();
        }
